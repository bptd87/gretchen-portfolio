          ...
          <div className="mx-auto max-w-6xl">
            <div className="grid items-start gap-10 lg:grid-cols-[minmax(0,1fr)_21rem] lg:gap-16">
              <div className="space-y-7">
                <h2 className="text-3xl font-serif italic text-foreground sm:text-4xl">
                  About the Artist
                </h2>
                ...
                <div className="font-editorial max-w-3xl space-y-5 text-[1.08rem] leading-[1.95] text-foreground/82 sm:text-[1.13rem]">
              ...
              <div className="grid gap-6 sm:grid-cols-2 lg:sticky lg:top-28 lg:grid-cols-1">
                <div className="soft-panel aspect-[4/5] overflow-hidden rounded-[1.2rem]">
                  <FadeInNextImage
                    ...
                    width={1200}
                    height={1600}
                    sizes="(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 21rem"
                    className="h-full w-full object-cover"
                  />
                </div>

                <figure className="soft-panel self-start overflow-hidden rounded-[1.2rem]">
                  <FadeInNextImage
                    ...
                    height={1000}
                    sizes="(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 21rem"
                    wrapperClassName="aspect-[7/5] h-auto"
                    className="h-full w-full object-cover"
                  />
                  <figcaption className="border-t border-border/70 px-4 py-3 text-center">
                    <p className="font-serif text-sm italic leading-snug text-foreground sm:text-[0.95rem]">
        ...
        <section className="px-4 pb-20 pt-6 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-7">
              <a
                href={`mailto:${aboutPageContent.contact.email}`}
                className="group flex w-20 flex-col items-center gap-3 text-accent"
                aria-label="Email Gretchen Ugalde"
              >
                <span className="flex h-12 w-12 items-center justify-center rounded-[8px] border border-accent/60 bg-background/70 transition-all duration-300 group-hover:-translate-y-0.5 group-hover:border-accent group-hover:bg-accent group-hover:text-accent-foreground">
                  <Mail className="h-5 w-5" />
                </span>
                <span className="font-sans text-[0.68rem] uppercase tracking-[0.22em] text-muted-foreground transition-colors group-hover:text-accent">
                  Email
                </span>
              </a>
              <a
