      ...
      <div className="container py-14">
        ...
        <div className="grid gap-10 md:grid-cols-[1.6fr_1fr_1fr]">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/" className="font-sans text-sm text-muted-foreground transition-colors hover:text-accent">
                  Portfolio
                </Link>
              </li>
              <li>
                <Link href="/resume" className="font-sans text-sm text-muted-foreground transition-colors hover:text-accent">
                  Resume
                </Link>
              </li>
              <li>
                <Link href="/about" className="font-sans text-sm text-muted-foreground transition-colors hover:text-accent">
                  About
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-10 border-t border-border/70 pt-8 text-center">
          <p className="font-sans text-sm text-muted-foreground">
            © {currentYear} Gretchen Ugalde. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
